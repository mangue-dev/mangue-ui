  ...
  "group/badge inline-flex h-7 w-fit shrink-0 items-center justify-center gap-1.5 overflow-hidden rounded-full px-3 text-xs font-medium whitespace-nowrap transition-all focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3.5",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-muted text-foreground [a]:hover:bg-accent [a]:hover:text-foreground [button]:hover:bg-accent [button]:hover:text-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
