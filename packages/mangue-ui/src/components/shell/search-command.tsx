      ...
      >
        <PopoverAnchor asChild>
          <div
            ...
            className={cn(
              "flex h-8 cursor-text items-center gap-1.5 rounded-full bg-control px-3 font-sans text-xs font-medium shadow-xs transition-colors hover:bg-control-hover focus-within:outline-none",
              className,
            )}
          >
